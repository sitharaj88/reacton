...
exports.ReactonProvider = void 0;
...
class ReactonProvider {
    ...
    getGroupItems() {
        ...
        return groups
            ...
            const item = new ReactonTreeItem(`${g.label} (${count})`, vscode.TreeItemCollapsibleState.Expanded);
    ...
    getReactonItems(type) {
        return this.scanner.reactons
            ...
            const doc = reacton.docComment
                ? `\n\n---\n\n${reacton.docComment}`
                : '';
            item.tooltip = new vscode.MarkdownString(`**${reacton.name}** \`${reacton.type}\`\n\n` +
    ...
    getDependencyItems(reactonName) {
        ...
        return reacton.dependencies.map((depName) => {
            ...
            const item = new ReactonTreeItem(depName, vscode.TreeItemCollapsibleState.None);
...
exports.ReactonProvider = ReactonProvider;
class ReactonTreeItem extends vscode.TreeItem {
}
//# sourceMappingURL=reacton_provider.js.map