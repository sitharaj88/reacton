...
class ReactonGraphPanel {
    static createOrShow(extensionUri, scanner) {
        ...
        const panel = vscode.window.createWebviewPanel(ReactonGraphPanel.viewType, 'Reacton Dependency Graph', column || vscode.ViewColumn.One, {
            enableScripts: true,
            retainContextWhenHidden: true,
        });
        ReactonGraphPanel.currentPanel = new ReactonGraphPanel(panel, scanner);
    }
    constructor(panel, scanner) {
        this._disposables = [];
        this._panel = panel;
        this.update(scanner);
    ...
    _getHtmlForWebview(reactons, edges) {
        const reactonsJson = JSON.stringify(reactons.map((a) => ({
            name: a.name,
            type: a.type,
...
exports.ReactonGraphPanel = ReactonGraphPanel;
ReactonGraphPanel.viewType = 'reactonGraph';
//# sourceMappingURL=graph_panel.js.map